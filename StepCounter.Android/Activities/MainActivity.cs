...
{
    [Activity(Label = "Step Counter", Icon = "@drawable/ic_launcher", LaunchMode = LaunchMode.SingleTask, MainLauncher = true, ScreenOrientation = ScreenOrientation.Portrait)]
    public class MainActivity : BaseActivity
    {
        ...
        bool registered;
        string calorieString, distanceString, percentString, completedString;
        ...
        StepServiceConnection serviceConnection;
        //private int testSteps = 1;
        TextView stepCount, calorieCount, distance, percentage;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            distanceString = Resources.GetString(Settings.UseKilometeres ? Resource.String.kilometeres : Resource.String.miles);
        ...
        void AnimateTopLayer(float percent, bool force = false)
        {
            if (!canAnimate)
                return;
            ...
            RunOnUiThread(() =>
                {
                    ...
                    var lbs = Settings.UseKilometeres ? Helpers.Settings.Weight * 2.20462 : Helpers.Settings.Weight;
