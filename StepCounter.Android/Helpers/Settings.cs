...
namespace StepCounter.Helpers
{
    ...
    public static class Settings
    {
        ...
        static readonly int WeightDefault = 0;

        public const string CadenceKey = "Cadence3";
        static readonly string CadenceDefault = "3";

        public const string EnhancedKey = "Enhanced";
        static readonly bool EnhancedDefault = false;

        public const string ProgressNotificationsKey = "ProgressNotifications";
        static readonly bool ProgressNotificationsDefault = true;

        public const string AccumulativeNotificationsKey = "AccumulativeNotifications";
        static readonly bool AccumulativeNotificationsDefault = true;

        const string CurrentDayKey = "CurrentDay";
        static readonly DateTime CurrentDayDefault = DateTime.Today;

        const string CurrentDayStepsKey = "CurrentDaySteps";
        static readonly Int64 CurrentDayStepsDefault = 0;


        const string StepsBeforeTodayKey = "StepsBeforeToday";
        static readonly Int64 StepsBeforeTodayDefault = 0;

        const string TotalStepsKey = "TotalSteps";
        static readonly Int64 TotalStepsDefault = 0;

        const string GoalTodayMessageKey = "GoalTodayMessage";
        static readonly string GoalTodayMessageDefault = string.Empty;

        const string GoalTodayDayKey = "GoalTodayDay";
        static readonly DateTime GoalTodayDayDefault = DateTime.Today.AddDays(-1);

        const string NextGoalKey = "NextGoal";
        const Int64 NextGoalDefault = 100000;

        const string HighScoreKey = "HighScore";
        public const Int64 HighScoreDefault = 0;

        const string HighScoreDayKey = "HighScoreDay";
        static readonly DateTime HighScoreDayDefault = DateTime.Today;


        const string FirstDayOfUseKey = "FirstDayOfUse";
